module.exports = {
  ...
  "rules": {
    ...
    "at-rule-no-unknown": [true, { "ignoreAtRules": ["use", "forward", "mixin", "include", "if", "else", "each", "function", "return"] }],
    "selector-pseudo-class-no-unknown": true,
    "selector-pseudo-element-no-unknown": true,
    "selector-type-no-unknown": true,
    "media-feature-name-no-unknown": true,
    "function-no-unknown": [true, { "ignoreFunctions": ["scale-color", "map-get", "fade-in", "if"] }],
